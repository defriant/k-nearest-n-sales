    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Periode</p>
                @if ($lastPeriod == null)
                    <input type="text" id="monthYear" class="form-control periodePicker" style="background: transparent;" value="" readonly>
                @else
                    <input type="text" id="monthYear" class="form-control" style="background: transparent;" value="{{ $lastPeriod }}" readonly>
                @endif
                <br>
                <p>Total Stok Awal</p>
